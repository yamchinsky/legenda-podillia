      ...
      <div className="flex flex-col items-center w-full max-w-[1234px]">
        <div className="flex flex-col lg:flex-row gap-10 items-center lg:items-start w-full justify-center lg:justify-between">
          <nav className="flex flex-col items-center lg:items-start text-xl font-light">
            <h3 className="text-2xl font-bold">ГО "ЛЕГЕНДА ПОДІЛЛЯ"</h3>
            <ul className="mt-4 space-y-2">
              <li>
                <a href="#home" className="hover:underline">Головна</a>
              </li>
              <li>
                <a href="#about" className="hover:underline">Про нас</a>
              </li>
              <li>
                <a href="#contact" className="hover:underline">Зв'язатися з нами</a>
              </li>
            </ul>
          </nav>
        ...
        <p className="mt-4 text-lg text-center">2024 ГО "ЛЕГЕНДА ПОДІЛЛЯ". Всі права захищені.</p>
      </div>
    </footer>
  );
};
